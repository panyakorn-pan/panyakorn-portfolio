...
STROKES = [
    ...
    # 2) หางสะบัดออกขวายาวๆ เหมือนขีดใต้ลายเซ็น เรียวจนแหลมเป็นปลายเข็ม
    ((252, 828), (360, 930), (680, 906), (904, 726),
     36, 26, 3),
    ...
    # ---- ตัว S (Singhadoung) ลอยเหนือเส้นหาง เหมือนอักษรย่อนามสกุลในลายเซ็นจริง ----
    # ตั้งใจทำให้บางและเล็กกว่าตัว P ชัดเจน เพื่อให้ P ยังเป็นพระเอกอยู่
    # 5) โค้งบนของ S — กางออกทางขวาแล้ววาดกลับมาทางซ้าย
    ((778, 596), (694, 546), (582, 566), (596, 642),
     5, 17, 21),

    # 6) เส้นกลางของ S — ลากเฉียงกลับไปทางขวา
    ((596, 642), (608, 704), (740, 692), (748, 756),
     21, 22, 21),

    # 7) โค้งล่างของ S — กวาดกลับซ้ายแล้วเรียวจบ
    ((748, 756), (756, 818), (632, 826), (556, 782),
     21, 15, 4),
]
